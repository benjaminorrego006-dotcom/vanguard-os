  ...
  return `
    <div id="ingreso-modal" class="modal-overlay">
      <div class="modal-content" style="padding: 24px; padding-bottom: max(24px, env(safe-area-inset-bottom)); max-height: 90vh; position: relative;">
        ...
        <!-- Description -->
        <input type="text" id="ingreso-label" placeholder="Descripción (opcional, ej. Salario)" style="width: 100%; background: var(--surface-2); border: none; color: var(--text-primary); padding: 16px; border-radius: 12px; font-size: 16px; box-sizing: border-box; margin-bottom: 24px; outline: none;">
